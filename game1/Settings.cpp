...
void Settings::initButtons()
{
	...
	this->buttons["NOT_FULL_SCREEN"] = new Button(100, 600, 200, 30, &this->font, "Windowed", sf::Color::White, sf::Color::Red, sf::Color::Blue);
...
void Settings::update(const sf::Time dt)
{
	...
	if (this->buttons["NOT_FULL_SCREEN"]->isPressed())	//work in progress
	{
		...
		Application app;
		app.run();
		//window.create(sf::VideoMode(1600, 900), "Game1", sf::Style::Close);
	}
